         ...
         if (!popup.isOpen()) {
             ...
             if (featureEvent.data.nombre) {
                 ...
                 if (featureEvent.data.fuente == 'RegCentral') {
                     content += `<center><button type="button" id ="mostrarRedFundacion" data-toggle="agenttip" data-placement="right" title="Mostrar la red de fundadores derivada desde esta fundación" class="btn btn-primary" style="z-index: 10; width: 70%;">Mostrar red fundadores</button></center><br>`;
                     content += `<center><button type="button" id ="mostrarRedPatronosFundacion" data-toggle="agenttip" data-placement="right" title="Mostrar la red de patronos derivada desde esta fundación" class="btn btn-primary" style="z-index: 10; width: 70%;">Mostrar red patronos</button></center><br>`;
                     content += `<center><button type="button" id ="irRegistroFundacion" data-toggle="agenttip" data-placement="right" title="Mostrar la fundación en el registro" class="btn btn-primary" style="z-index: 10; width: 70%;">Ir al registro</button></center><br>`;
                     content += `<canvas id="fundadores-genero" width="150" height="100"></canvas>`;
                 } else if (featureEvent.data.fuente == 'EuskadiOpenData') {
                     content += `<center><button type="button" id ="irRegistroFundacionEuskadi" data-toggle="agenttip" data-placement="right" title="Mostrar la fundación en el registro" class="btn btn-primary" style="z-index: 10; width: 70%;">Ir al registro</button></center><br>`;
